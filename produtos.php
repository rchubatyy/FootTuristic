...
<div id="templatemo_main">
    	<div id="sidebar" class="float_l">
			...
			<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                    	<li class="first"><input type="radio" name="genero" id="botaofiltro" value="senhora">Senhora</li>
                        <li class="last"><input type="radio" name="genero" id="botaofiltro2" value="homem">Homem</li>
                    </ul>
                </div>
			</div>
        	<div class="sidebar_box"><span class="bottom"></span>
...
{ 
	...
	if (isset($_REQUEST['ordenar']) && $_REQUEST['ordenar']=="preco_asc")
	{
		...
		<?php
		$sql = 'SELECT * FROM produtos WHERE Genero="Senhora" ORDER BY Preco ASC';
		GeraColunas($con, 3, $sql)
		?>
		</td>
		</tr>
		</table>
	...
	{ 
		...
		<?php
		$sql = 'SELECT * FROM produtos WHERE Genero="Senhora" ORDER BY Preco DESC';
		GeraColunas($con, 3, $sql)
		?>
		</td>
		</tr>
	...
	else
	{
		...
		<script>checksenhora()</script>
		<?php
		$sql = 'SELECT * FROM produtos WHERE Genero="Senhora" ORDER BY RAND()';
		GeraColunas($con,3,$sql)
		?>
		</td>
		</tr>
...
{ 
	...
	if (isset($_REQUEST['ordenar']) && $_REQUEST['ordenar']=="preco_asc")
	{
		...
		<script>checkprecoasc()</script>
		<?php
		$sql = 'SELECT * FROM produtos WHERE Genero="Homem" ORDER BY Preco ASC';
		GeraColunas($con3, $sql)
		?>
		</td>
		</tr>
		</table>
	...
	{ 
		...
		<script>checkprecodesc()</script>
		<?php
		$sql = 'SELECT * FROM produtos WHERE Genero="Homem" ORDER BY Preco DESC';
		GeraColunas($con,3, $sql)
		?>
		</td>
		</tr>
	...
	else
	{
		...
		<td>
		<?php
		$sql = 'SELECT * FROM produtos WHERE Genero="Homem" ORDER BY RAND()';
		GeraColunas($con,3,$sql)
		?>
		</td>
		</tr>
...
<div id="templatemo_footer">
    	...
    	Copyright © 2014 <a href="index.php">FootTuristic Calçado</a> </div> 
