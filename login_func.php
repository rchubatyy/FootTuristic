...
<fieldset class="fieldset-auto-width">
	<form align="left" name="login" id="login" method="post" action="submeterlogin_func.php">
	  Username:<br />
	  <input type="text" onBlur="verificar_username(login_username,erro_username)" id="login_username" name="login_username" autofocus="True"/><br />
	  <div id="erro_username" hidden="true"><font face="Arial" size="1px" color="red">Username inválido</font></div>
	  
	  Password:<br />
	  <input type="password" onBlur="verificar_password(login_pass,erro_pass)" id="login_pass" name="login_pass" /><br />
	 ...
	 Tipo utilizador:<br />
	<select name="tipo">
		<option value="Gerentes" selected>Gerentes</option>
		<option value="Lojistas">Lojistas</option>
	</select>
	<br />
	<br />
	  <center><input type="submit" name="Login" id="submeter" value="Login"  /></br></center>
