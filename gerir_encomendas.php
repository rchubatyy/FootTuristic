...
$dinheiro_despenc_anual = $dinheiro_compras_anual * 0.3;
$saldo_compras_anual = $dinheiro_compras_anual-$dinheiro_despenc_anual;
...
$dinheiro_desp_anual = $dinheiro_enc_anual * 0.3;
$saldo_enc_anual = $dinheiro_enc_anual-$dinheiro_desp_anual;
...
<div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
			...
			<?php
				if($_SESSION['TipoUtilizador']=="Gerente")
				{ 
               echo '<li><a href="gerir_encomendas.php" class="selected">Gerir Encomendas ('.$num_encomendas.')</a> </li>';
    	...
    	<div id="sidebar" class="float_l">
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
					...
					<?php echo "<li class='first'>Ganhos: <span STYLE='color:green'>" .number_format($dinheiro_enc,2,',','.')." €  </span></li>";
					echo "<li>Despesa: <span STYLE='color:red'>" .number_format($dinheiro_desp,2,',','.')." €  </span></li>";
					echo "<li>Nº Encomendas:<b> $num_enc </b></li>"; 
					if ($saldo<0)
...
<table width="700px" border="0" cellspacing="0" cellpadding="5">
  <tr bgcolor="#ddd">
	...
	<th width="90" align="center">LOJA</th>
	...
	{echo "<td><div align='center'><a href='alterar_estado.php?tipo=encomenda&id=".$rows['Encomenda_Id']."&acao=alterar'>Alterar</a></tr>";}
	else 
	echo "<td><div align='center'><a href='alterar_estado.php?tipo=encomenda&id=".$rows['Encomenda_Id']."&acao=alterar'>Alterar</a>|<a href='compras.php?id=".$rows['Encomenda_Id']."&acao=excluir'>Remover</a></div></td></tr>";
	}
 ?>
</table>
</form>
