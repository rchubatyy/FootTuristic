...
$username=$_SESSION['Username'];
    if (isset($_POST['nova_password']))
$novo_pass=$_POST['nova_password'];

if ($_POST['editar_perfil']=="perfil")
{
	mysqli_query($conn, "UPDATE clientes SET Nome='$novo_nome', Morada='$novo_morada', Localidade='$novo_localidade', Telefone='$novo_telefone', NIF='$novo_nif' WHERE Username='$username'") or die(mysqli_error($conn));
	
	echo "Perfil actualizado com sucesso! Voltar á página de <a href='perfil.php'>perfil</a>.";
}

else if($_POST['editar_perfil']=="pass")
{
mysqli_query($conn, "UPDATE clientes SET Password='$novo_pass' WHERE Username='$username'") or die(mysqli_error());
	
	echo "Password alterada com sucesso! Voltar á página de <a href='perfil.php'>perfil</a>.";
}
